...
const CATEGORIES: Array<"All" | MenuCategory> = ["All", "Drinks", "Bakery", "Food", "Beans"];
        ...
        <div className="flex flex-col gap-12 pb-20">
            ...
            >
                ...
                <div className="relative z-10 mx-auto flex h-full max-w-5xl flex-col justify-center gap-6 px-6 md:px-10">
                    <p className="text-sm uppercase tracking-[0.3em] text-orange-200">Menu</p>
                    ...
                    <p className="max-w-xl text-lg text-orange-50/80">
                        Browse our seasonal drinks and chef-inspired pairings, then place your order
                        so it’s hot and waiting when you arrive.
                    </p>
