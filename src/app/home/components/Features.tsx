               ...
               <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                         ...
                         <div className="flex flex-col justify-center">
                              ...
                              <p className="text-gray-600 leading-relaxed mb-8">
                                   ...
                                   traditional recipes and quality ingredients. From buttery croissants
                                   to artisan breads, each item is crafted with care to complement
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                         ...
                         <div className="flex flex-col justify-center">
                              ...
                              <p className="text-gray-600 leading-relaxed mb-8">
                                   We source our beans from the finest coffee-growing regions around
                                   the world and roast them in small batches to bring out their unique
                                   flavors. Take home a bag of our signature blends or explore our
