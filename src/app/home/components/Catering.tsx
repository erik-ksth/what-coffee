                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                         ...
                         <div>
                              ...
                              <p className="text-gray-600 leading-relaxed mb-8">
                                   Make your next event unforgettable with What Coffee catering.
                                   From corporate meetings to private celebrations, we bring our
                                   signature drinks and warm hospitality directly to you. Our team
                                   will work with you to create a custom menu that fits your occasion,
                                   whether it is freshly brewed coffee, handcrafted lattes, or our
                                   famous matcha creations.
                              </p>
                              <Link
                                   href="/contact"
