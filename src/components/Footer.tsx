...
export default function Footer() {
    return (
        <footer id="main-footer" className="w-full bg-background text-foreground pt-24 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-24">
                    ...
                    <div className="md:col-span-5 flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-xl text-foreground/65 max-w-sm leading-relaxed">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex flex-col gap-6 text-foreground/65">
                            <div>
                                <a
                    ...
                    <div className="flex gap-6">
                        {[
                            ...
                            <a
                                ...
                                className="w-10 h-10 bg-foreground flex items-center justify-center text-background hover:bg-primary transition-colors duration-300 group rounded-full"
                            >
